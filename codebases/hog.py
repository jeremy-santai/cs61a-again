...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    pscore = sus_points(
        take_turn(num_rolls, player_score, opponent_score, dice) + player_score
    )
    return pscore
    # END PROBLEM 4
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    pscore, oscore = 0, 0
    num1 = strategy(pscore, oscore)
    while pscore < goal:
        while oscore < goal:
            num2 = strategy(pscore, oscore)
            if num2 - num1 != 0:
                return False
            else:
                oscore += 1
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    pscore = sus_update(0, score, opponent_score)
    if pscore - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
